...
void omap_sram_idle(void)
{
	...
	//printk(KERN_INFO "PM34xx: %s:%d per_next_state=%d, core_next_state=%d",
	//		__FUNCTION__, __LINE__, per_next_state, core_next_state);
	...
	//printk(KERN_INFO "PM34xx: %s:%d mpu_next_state=%d", __FUNCTION__, __LINE__, mpu_next_state);
	/*
	...
	if (core_next_state < PWRDM_POWER_ON) {
		...
		if (core_next_state == PWRDM_POWER_OFF) {
			//printk(KERN_INFO "PM34xx: %s:%d core_next_state = PWRDM_POWER_OFF", __FUNCTION__, __LINE__);
		...
		//printk(KERN_INFO "PM34xx: %s:%d Before call omap_uart_resume_idle, core_next_state = %d",
		//			__FUNCTION__, __LINE__, core_next_state);
	...
	*/
	...
	if (core_next_state < PWRDM_POWER_ON) {
		...
		//printk(KERN_INFO "PM34xx: %s:%d core_next_state = %d, core_prev_state = %d",
		//		__FUNCTION__, __LINE__, core_next_state, core_prev_state);
	...
	/* PER */
	//printk(KERN_INFO "PM34xx: %s:%d per_next_state = %d",	__FUNCTION__, __LINE__, per_next_state);
	if (per_next_state < PWRDM_POWER_ON) {
		if (per_next_state == PWRDM_POWER_OFF) {
			/*
			...
			//printk(KERN_INFO "PM34xx: %s:%d per_prev_state = %d",
			//					__FUNCTION__, __LINE__, per_prev_state);
...
static int omap3_pm_suspend(void)
{
	...
	printk(KERN_INFO "Before call omap_uart_prepare_suspend");
	...
	printk(KERN_INFO "after call trace_pm_suspend_exit");
