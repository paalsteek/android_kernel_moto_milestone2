...
static void init_gpu_proc_fs(void) {
	...
	proc_entry = create_proc_read_entry("gpu/cur_rate", 0444, NULL, proc_cur_rate_read, NULL);
	proc_entry = create_proc_read_entry("gpu/max_rate", 0666, NULL, proc_max_rate_read, NULL);
